(defsystem "lulamoon"
  ...
  :license "MIT"
  :homepage "https://github.com/commonlainse/lulamoon"
  :bug-tracker "https://github.com/commonlainse/lulamoon/issues"
  :source-control "https://github.com/commonlainse/lulamoon.git"
  :depends-on ("trivia"
